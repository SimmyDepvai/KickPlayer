...
while wait() do 
    ...
    local Toggle = Tabs.Qs:AddToggle("MyToggle", {Title = "Lấy Saber", Default = false })
...
local Toggle = Tabs.Qs:AddToggle("MyToggle", {Title = "Lấy Yama", Default = false })
    ...
    local Toggle = Tabs.Qs:AddToggle("MyToggle", {Title = "Lấy Tushita", Default = false })
